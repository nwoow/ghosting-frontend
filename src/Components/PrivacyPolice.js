    ...
    return (
        <div className='container'>
            ...
            <ul style={{color:"white"}}>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Ghosting tech.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Ghosting tech, accessible from <a href="https://shop.ghosting.in/" rel="external nofollow noopener" target="_blank">https://shop.ghosting.in/</a></p>
                </li>
                <li>
                    <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
                </li>
            </ul>
            <h2 style={{color:"white"}}>Collecting and Using Your Personal Data</h2>
            ...
            <h4 style={{color:"white"}}>Usage Data</h4>
            ...
            <h4 style={{color:"white"}}>Tracking Technologies and Cookies</h4>
            ...
            <h4 style={{color:"white"}}>Business Transactions</h4>
            <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
            <h4 style={{color:"white"}}>Law enforcement</h4>
            <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
            <h4 style={{color:"white"}}>Other legal requirements</h4>
            ...
            <ul style={{color:"white"}}>
                <li>By email: ghostingtech@gmail.com</li>
            </ul>
